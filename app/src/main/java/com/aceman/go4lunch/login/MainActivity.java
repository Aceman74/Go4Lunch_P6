...
public class MainActivity extends BaseActivity implements LoginContract.LoginViewInterface {
    ...
    public void updateUIWhenResuming() {
        mBtnLogin.setText(this.isCurrentUserLogged() ? getApplicationContext().getString(R.string.button_login_text_logged) : getApplicationContext().getString(R.string.button_login_text_not_logged));
